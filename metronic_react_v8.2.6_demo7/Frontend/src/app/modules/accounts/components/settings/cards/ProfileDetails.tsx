...
const profileDetailsSchema = Yup.object().shape({
  ...
  phone: Yup.string().matches(/^[0-9]+$/, "Contact number only").min(8),
})
...
const ProfileDetails: React.FC = () => {
  ...
  const formik = useFormik<Partial<UserModel>>({
    initialValues: {
      pic: currentUser?.pic || 'media/avatars/blank.png',
      first_name: currentUser?.first_name || '',
      last_name: currentUser?.last_name || '',
      companyName: currentUser?.companyName || '',
      phone: currentUser?.phone || '',
      website: currentUser?.website || 'https://keenthemes.com',
    ...
    onSubmit: async (values) => {
      setLoading(true)
      try {
        if (auth?.api_token && currentUser?._id) {
          const updatedUser = await UpdateUser(
            currentUser._id as ID,
            values,
            auth.api_token
          )
      ...
      <div id='kt_account_profile_details' className='collapse show'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
              ...
              <div className='col-lg-8'>
                ...
                >
                  <div
                    ...
                    style={{ backgroundImage: `url(${formik.values.pic && formik.values.pic !== '' ? toAbsoluteUrl(formik.values.pic) : toAbsoluteUrl('media/avatars/blank.png')})` }}
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>companyName</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>
                <span className='required'>companyName Site</span>
              </label>
              ...
              <div className='col-lg-8 fv-row'>
                <input
                  type='text'
                  className='form-control form-control-lg form-control-solid'
                  placeholder='companyName website'
                ...
                <div className='d-flex align-items-center mt-3'>
                  <label className='form-check form-check-inline form-check-solid me-5'>
                    <input
                      ...
                      name='communication[]'
                      type='checkbox'
                      defaultChecked={formik.values.communication?.email}
                      onChange={() => {
                        formik.setFieldValue('communication.email', !formik.values.communication?.email)
                      }}
                    />
                  ...
                  <label className='form-check form-check-inline form-check-solid'>
                    <input
                      ...
                      name='communication[]'
                      type='checkbox'
                      defaultChecked={formik.values.communication?.phone}
                      onChange={() => {
                        formik.setFieldValue('communication.phone', !formik.values.communication?.phone)
                      }}
                    />
              ...
              <div className='col-lg-8 d-flex align-items-center'>
                <div className='form-check form-check-solid form-switch fv-row'>
                  <input
                    ...
                    type='checkbox'
                    id='allowmarketing'
                    // ใช้ checked แทน defaultChecked เพื่อให้ UI อัปเดตตาม State ตลอดเวลา
                    checked={formik.values.allowMarketing || false}
                    onChange={() => {
                      formik.setFieldValue('allowMarketing', !formik.values.allowMarketing)
                    }}
                  />
